...
class FreeVocab_MaskWise:
    ...
    def get_final_instance(self, scene_id, cfg):
        ...
        for (obj_id, inst) in enumerate(tqdm(self.instance3d)):
            ...
            ##########NOTE: Obtaining top-k views########## Poor results
            ...
            feat = torch.stack(feat, 0).squeeze(1)
        ...
        if len(self.class_names) < 100: # scannetpp
            ...
            instance3d = self.instance3d # (we cannot query 3D as it is maskwise)
